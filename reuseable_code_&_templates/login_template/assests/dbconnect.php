...
//you should not use root to access the database as its full access tempry
    $dbusername = "username";//gets the user name we need to access the database in the correct way

    $dbpassword = "pasword";//password for database useraccont

    $dbname = "databasename";// database name to connect to
